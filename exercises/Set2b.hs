...
oddFactorial 1 = 1
oddFactorial 2 = 1
oddFactorial n = k * oddFactorial (k-2)
                where k = n + (n `mod` 2 - 1)
...
leftpad str n
    | length str >= n = str
    | otherwise = leftpadHelper str (n - length str )

leftpadHelper :: String -> Int -> String
leftpadHelper str k
    | k == 0 = str
    | otherwise = leftpadHelper (" " ++ str) (k-1)
------------------------------------------------------------------------------
...
countdown int = "Ready! " ++ countdownHelper int
